...
void SerialInit(void)
{
	...
	PORT_Init(PORTC, PIN7, FUNMUX0_UART0_RXD, 1);	//GPIOA.2配置为UART0输入引脚
	PORT_Init(PORTC, PIN6, FUNMUX1_UART0_TXD, 0);	//GPIOA.3配置为UART0输出引脚
